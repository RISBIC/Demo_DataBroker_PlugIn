...
public class CompaniesHouseSpreadsheet2JDBCProcessorFactory implements DataFlowNodeFactory
{
    public CompaniesHouseSpreadsheet2JDBCProcessorFactory(String name, Map<String, String> properties)
    {
        _name       = name;
