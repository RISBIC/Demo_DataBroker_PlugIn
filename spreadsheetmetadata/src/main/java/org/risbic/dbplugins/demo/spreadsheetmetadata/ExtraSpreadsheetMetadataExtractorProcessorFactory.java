...
public class ExtraSpreadsheetMetadataExtractorProcessorFactory implements DataFlowNodeFactory
{
    public ExtraSpreadsheetMetadataExtractorProcessorFactory(String name, Map<String, String> properties)
    {
        _name       = name;
        ...
        throws InvalidClassException, InvalidMetaPropertyException, MissingMetaPropertyException
    {
        if (dataFlowNodeClass.equals(DataProcessor.class))
        {
            if (metaProperties.isEmpty())
            {
                ...
                propertyNames.add(ExtraSpreadsheetMetadataExtractorProcessor.METADATABLOB_ID_PROPNAME);
                propertyNames.add(ExtraSpreadsheetMetadataExtractorProcessor.LOCATION_PROPNAME);
        ...
        throws InvalidClassException, InvalidNameException, InvalidMetaPropertyException, MissingMetaPropertyException, InvalidPropertyException, MissingPropertyException
    {
        ...
        {
            if (metaProperties.isEmpty())
                return (T) new ExtraSpreadsheetMetadataExtractorProcessor(name, properties);
            else
                throw new InvalidMetaPropertyException("No metaproperties expected", null, null);
        }
        else
