...
public class ExtraJSONMetadataExtractorProcessorFactory implements DataFlowNodeFactory
{
    public ExtraJSONMetadataExtractorProcessorFactory(String name, Map<String, String> properties)
    {
        _name       = name;
        ...
        throws InvalidClassException, InvalidMetaPropertyException, MissingMetaPropertyException
    {
        if (dataFlowNodeClass.equals(DataProcessor.class))
        {
            if (metaProperties.isEmpty())
            {
                ...
                propertyNames.add(ExtraJSONMetadataExtractorProcessor.METADATABLOB_ID_PROPNAME);
                propertyNames.add(ExtraJSONMetadataExtractorProcessor.LOCATION_PROPNAME);
        ...
        throws InvalidClassException, InvalidNameException, InvalidMetaPropertyException, MissingMetaPropertyException, InvalidPropertyException, MissingPropertyException
    {
        ...
        {
            if (metaProperties.isEmpty())
                return (T) new ExtraJSONMetadataExtractorProcessor(name, properties);
            else
                throw new InvalidMetaPropertyException("No metaproperties expected", null, null);
        }
        else
